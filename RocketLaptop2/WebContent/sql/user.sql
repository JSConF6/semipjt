CREATE TABLE MEMBER(
	...
	USER_ADDRESS1 NUMBER(10) NOT NULL, -- 회원 우편번호
...
insert into member
values('jsp', 1234, '제이', 19940101, '여자', 'jsp@naver.com', '010-1111-1111', 31006, '서울 종로구', 'product.png', sysdate);
...
insert into member
values('vue', 1234, '뷰', 19960101, '남자', 'vue@naver.com', '010-1111-1111', 31006, '서울 종로구', 'product.png', sysdate);
